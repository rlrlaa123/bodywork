<div class="sidebar developmentinfo {{ preg_match('/admin\/notice/', $_SERVER['REQUEST_URI']) ||
    ...
    <div class="sidesubmenu">
        <ul>
            ...
            <li class="selector {{ preg_match('/\/admin\/lesson/', $_SERVER['REQUEST_URI']) ? 'active' : '' }}">
                <a href="/admin/lesson">PT 레슨문의</a>
            </li>
            <li class="selector {{ preg_match('/\/admin\/freelesson/', $_SERVER['REQUEST_URI']) ? 'active' : '' }}">
