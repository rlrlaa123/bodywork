...
@section('content')
    ...
    <div class="pt-info-1">
        <img src="/img/pt_program/2.jpg" width="100%" height="300px">
        <img src="/img/pt_program/comma.png" width="40px" style="margin: 50px 0;">
        <p style="margin: 20px 0;">퍼스널트레이닝이란?
    ...
    <div class="pt-info-2">
        ...
        <img src="/img/pt_program/comma.png" width="40px">
