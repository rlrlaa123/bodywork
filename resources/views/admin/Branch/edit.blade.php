    ...
    <form method="POST" action="{{ route('admin.branch.update', $branch->id) }}" enctype="multipart/form-data">
        ...
        <table>
            <tr>
                ...
                <td class="td-input">
                    <input id="number" name="number" type="number" value="{{ old('number', $branch->number) }}" readonly>
            ...
            <tr>
                ...
                <td class="td-input">
                    <input id="time1" name="time1" type="text" value="{{ old('time1', $branch->time1) }}">
                    @if ($errors->has('time1'))
                        <div class="help-block">
                            {{ $errors->first('time1') }}
                        </div>
            ...
            <tr>
                ...
                <td class="td-input">
                    <input id="time2" name="time2" type="text" value="{{ old('time2', $branch->time2) }}">
                    @if ($errors->has('time2'))
                        <div class="help-block">
                            {{ $errors->first('time2') }}
                        </div>
            ...
            <tr>
                ...
                <td class="td-input">
                    <input id="time3" name="time3" type="text" value="{{ old('time3', $branch->time3) }}">
                    @if ($errors->has('time3'))
                        <div class="help-block">
                            {{ $errors->first('time3') }}
                        </div>
            ...
            <tr>
                ...
                <td class="td-input">
                    <input id="note" name="note" type="text" value="{{ old('note', $branch->note) }}">
                    @if ($errors->has('note'))
                        <div class="help-block">
                            {{ $errors->first('note') }}
                        </div>
            ...
            <tr>
                ...
                <td class="td-input">
                    ...
                    @endif
                    <a class="image-name" href="/{{ $branch->image1 }}">[ {{ substr($branch->image1, 19) }} ]</a>
                </td>
            </tr>
            <tr>
                ...
                <td class="td-input">
                    ...
                    @endif
                    <a class="image-name" href="/{{ $branch->image2 }}">[ {{ substr($branch->image2, 19) }} ]</a>
                </td>
            </tr>
            <tr>
                ...
                <td class="td-input">
                    ...
                    @endif
                    <a class="image-name" href="/{{ $branch->image3 }}">[ {{ substr($branch->image3, 19) }} ]</a>
                </td>
            </tr>
            <tr>
                ...
                <td class="td-input">
                    ...
                    @endif
                    <a class="image-name" href="/{{ $branch->image4 }}">[ {{ substr($branch->image4, 19) }} ]</a>
                </td>
            </tr>
            <tr>
                ...
                <td class="td-input">
                    ...
                    @endif
                    <a class="image-name" href="/{{ $branch->image5 }}">[ {{ substr($branch->image5, 19) }} ]</a>
                </td>
            </tr>
            <tr>
                ...
                <td class="td-input">
                    ...
                    @endif
                    <a class="image-name" href="/{{ $branch->image6 }}">[ {{ substr($branch->image6, 19) }} ]</a>
                </td>
            </tr>
            <tr>
                ...
                <td class="td-input">
                    ...
                    @endif
                    <a class="image-name" href="/{{ $branch->image7 }}">[ {{ substr($branch->image7, 19) }} ]</a>
                </td>
            </tr>
            <tr>
